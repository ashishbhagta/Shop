package com.DCMetal.Shop.security;

import com.DCMetal.Shop.model.AppRole;
import com.DCMetal.Shop.model.Role;
import com.DCMetal.Shop.model.User;
import com.DCMetal.Shop.repositories.RoleRepository;
import com.DCMetal.Shop.repositories.UserRepository;
import com.DCMetal.Shop.security.jwt.AuthEntryPointJwt;
import com.DCMetal.Shop.security.jwt.AuthTokenFilter;
import com.DCMetal.Shop.security.services.UserDetailsServiceImpl;
...
public class WebSecurityConfig {
    ...
    @Bean
    public CommandLineRunner initDataRoleRepository(RoleRepository roleRepository, UserRepository userRepository,PasswordEncoder passwordEncoder)
    {
        return args ->
        {
